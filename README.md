...
**AD backend support** — see the [Automatic differentiation backends tutorial](https://censoreddistributions.epiaware.org/dev/getting-started/tutorials/ad-backends/) for the full matrix and notes on broken combinations.
