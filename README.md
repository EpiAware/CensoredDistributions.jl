...
For information on AD support, scenario coverage, and per-backend benchmarks see the [Automatic differentiation backends](https://censoreddistributions.epiaware.org/dev/getting-started/tutorials/ad-backends/) tutorial.
