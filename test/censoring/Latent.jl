...
@testitem "latent leaf logpdf is ForwardDiff-safe in the parameters" begin
    using Distributions
    using ForwardDiff: gradient

    # The leaf marginal and latent logpdfs must both differentiate cleanly
    # through the parameters under ForwardDiff, and the marginal == latent
    # equivalence must hold at the gradient level: the parameter gradient of
    # the marginal logpdf equals the gradient of the latent joint integrated
