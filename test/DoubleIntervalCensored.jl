...
@testitem "Test double_interval_censored structure equivalence - with truncation" begin
    ...
    # Convenience function approach
    convenience_dist = double_interval_censored(delay_dist, primary_event_dist; upper=upper_bound)
...
@testitem "Test double_interval_censored structure equivalence - with interval censoring" begin
    ...
    # Convenience function approach
    convenience_dist = double_interval_censored(delay_dist, primary_event_dist; interval=interval_width)
...
@testitem "Test double_interval_censored return types" begin
    ...
    full_dist = double_interval_censored(gamma_dist, uniform_primary; upper=5, interval=0.5)
